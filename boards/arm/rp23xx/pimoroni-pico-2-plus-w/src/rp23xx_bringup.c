/****************************************************************************
 * boards/arm/rp23xx/pimoroni-pico-2-plus-w/src/rp23xx_bringup.c
 *
 ...
 *
 * The Pimoroni Pico Plus 2 W carries the Raspberry Pi RM2 module wired to
 * the same GPIOs as the official Raspberry Pi Pico W / Pico 2 W (confirmed
 * against the official pico-sdk board header,
 * src/boards/include/boards/pimoroni_pico_plus2_w_rp2350.h). The data line
 * is bidirectional (single-wire gSPI), so it is also used as the host-wake
 * interrupt line.
 */
