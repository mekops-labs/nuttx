...
#define RP23XX_QMI_DIRECT_CSR   (RP23XX_XIP_QMI_BASE + RP23XX_QMI_DIRECT_CSR_OFFSET)
#define RP23XX_QMI_DIRECT_TX    (RP23XX_XIP_QMI_BASE + RP23XX_QMI_DIRECT_TX_OFFSET)
#define RP23XX_QMI_DIRECT_RX    (RP23XX_XIP_QMI_BASE + RP23XX_QMI_DIRECT_RX_OFFSET)
#define RP23XX_QMI_M0_TIMING    (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M0_TIMING_OFFSET)
#define RP23XX_QMI_M0_RFMT      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M0_RFMT_OFFSET)
#define RP23XX_QMI_M0_RCMD      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M0_RCMD_OFFSET)
#define RP23XX_QMI_M0_WFMT      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M0_WFMT_OFFSET)
#define RP23XX_QMI_M0_WCMD      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M0_WCMD_OFFSET)
#define RP23XX_QMI_M1_TIMING    (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M1_TIMING_OFFSET)
#define RP23XX_QMI_M1_RFMT      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M1_RFMT_OFFSET)
#define RP23XX_QMI_M1_RCMD      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M1_RCMD_OFFSET)
#define RP23XX_QMI_M1_WFMT      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M1_WFMT_OFFSET)
#define RP23XX_QMI_M1_WCMD      (RP23XX_XIP_QMI_BASE + RP23XX_QMI_M1_WCMD_OFFSET)
#define RP23XX_QMI_ATRANS(n)    (RP23XX_XIP_QMI_BASE + RP23XX_QMI_ATRANS_OFFSET(n))
